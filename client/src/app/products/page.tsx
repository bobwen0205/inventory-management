...
const Products = () => {
  ...
  return (
    <div className="mx-auto pb-5 w-full">
      {/* SEARCH BAR */}
      <div className="mb-6">
        <div className="flex items-center border-2 border-gray-200 rounded focus-within:border-blue-500">
          ...
          products?.map((product) => (
            ...
            >
              <div className="flex flex-col items-center">
                <Image
                  src={`https://bobwen-s3-inventorymanagement.s3.us-east-1.amazonaws.com/product${
